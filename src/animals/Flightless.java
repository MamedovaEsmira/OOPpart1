...
public class Flightless extends Birds{
    ...
    public String toString() {
        return String.format("Класс: %s, %s. Имя: %s, возраст %d лет, среда обитания: %s.",
                Birds.class.getSimpleName(),Flightless.class.getSimpleName() , getName(),getAge(),getLivingArea());
    }
}